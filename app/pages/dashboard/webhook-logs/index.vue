...
const sort = ref<{ key: WebhookLogSortBy, order: WebhookLogSortOrder }>({ key: 'createdAt', order: 'desc' })
...
const CLIENT_SORT_ACCESSORS: Record<WebhookLogSortBy, (item: typeof webhookLogs.value[number]) => string> = {
...
const filteredLogs = computed(() => {
  ...
  return webhookLogs.value.filter((log) => {
...
function handleSort(patch: { sortBy: WebhookLogSortBy, sortOrder: WebhookLogSortOrder }) {
