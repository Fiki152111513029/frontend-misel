...
<template>
  <button
    ...
    :aria-busy="loading"
    :class="[
 'relative inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3.5 text-sm font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 overflow-hidden',
 fullWidth ? 'w-full' : '',
 variant === 'primary'
 ...
 : 'text-brand-blue hover:bg-brand-blue/10 focus:ring-brand-blue/30',
 ]"
  >
